...
public class LuaFramework_PanelManagerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("isContainsPanel", isContainsPanel);
		L.RegFunction("CloseAllPanel", CloseAllPanel);
		L.RegFunction("DestroyAllPanel", DestroyAllPanel);
	...
	static int GetPanel(IntPtr L)
	{
		try
		{
			...
			LuaFramework.PanelManager obj = (LuaFramework.PanelManager)ToLua.CheckObject<LuaFramework.PanelManager>(L, 1);
			string arg0 = ToLua.CheckString(L, 2);
			UnityEngine.GameObject o = obj.GetPanel(arg0);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int isContainsPanel(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			LuaFramework.PanelManager obj = (LuaFramework.PanelManager)ToLua.CheckObject<LuaFramework.PanelManager>(L, 1);
			string arg0 = ToLua.CheckString(L, 2);
			bool o = obj.isContainsPanel(arg0);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DestroyAllPanel(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
